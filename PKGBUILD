...
install='grub-android-prober.install'
pkgver=0.1.6
pkgrel=1
...
package_grub-android-prober() {
	...
	install -Dm755 "grub-android-prober" "$pkgdir/usr/sbin/grub-android-prober"
}
