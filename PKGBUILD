...
depends=('grub' 'bash')
makedepends=('git')
source=('30_android-prober' 'grub-android-prober' 'VERSION' 'android-prober.service::systemd/android-prober.service' 'android-prober@.timer::systemd/android-prober@.timer')
